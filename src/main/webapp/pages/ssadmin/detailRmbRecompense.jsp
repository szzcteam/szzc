...
<div style="width: 98%;height:842px;margin: 0px auto;padding-top: 20px;">
    ...
    <div style="width:47%;height:100%;float: left;padding-left: 15px">
        ...
        <c:choose>
            <c:when test="${rmbRecom.projectCode == 'B001001' or rmbRecom.projectCode == 'B001002' or rmbRecom.projectCode == 'B001003' or rmbRecom.projectCode == 'B001004' or rmbRecom.projectCode == 'B001005'}">
