                ...
                <table  border="1" class="tableInfo">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            ...
                            <input type="text" name="calcHotWaterCompensateConvert" value="${solarWaterHeaters}" class="none_border" placeholder="折算比例" size="5" style="margin-top: 2px;margin-left: 5px;width: 40px;"/>
                            <!--隐藏存储表单提交值-->
                   ...
                   <%--  <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <input type="text" name="newHouseName" value="${settleAccounts.newHouseName}" class="none_border" style="width: 400px;margin-right: 5px;">
                        </td>
