...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/addSystemArgs.html">
				<li><a class="add"
					   href="ssadmin/goSystemArgsJSP.html?url=ssadmin/addSystemArgs&uid={sid_user}"
					   height="400" width="800" target="dialog" rel="updateSystemArgs"><span>新增</span>
				</a></li>
			</shiro:hasPermission>
