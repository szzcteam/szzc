                ...
                <table  border="1" class="tableInfo">
                   ...
                   <tr>
                       ...
                       <td colspan="3">
                           ...
                           <!--无烟灶台选择-->
                           <select id="sel_stove" class="select_fix" style="display: none" price="${smokeFreeStove}">
                           ...
                           <!--隐藏存储表单提交值-->
                           <input type="hidden" name="calcStructureCompensate" value="${settleAccounts.calcStructureCompensate}" class="none_border width_220px">
                       </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" id="rmbMoveReward_td2"><input type="text" name="rmbMoveReward" value="${settleAccounts.rmbMoveReward}"  class="none_border width_110px"></td>
                        <td id="rmbMoveReward_td3"><input type="text" name="rmbMoveRewardBz" value="${settleAccounts.rmbMoveRewardBz}"  class="none_border width_70px"></td>
                    </tr>
                    <tr>
                        <td>十五</td>
