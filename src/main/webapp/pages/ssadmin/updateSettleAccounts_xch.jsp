...
<script type="text/javascript" src="${oss_url}/static/ssadmin/js/business/add_settleAccounts_xch.js"/>
            ...
            <dl>
                <table  border="1" class="tableInfo">
                    ...
                    <tr>
                        ...
                        <td colspan="4"><input type="text" name="calcDeduction" value="${settleAccounts.calcDeduction}" class="none_border" style="width: 400px"></td>
