            ...
            <fieldset>
                ...
                <dl>
                    ...
                    <dd style="width: 300px;">
                        ...
                        <input type="hidden" name="interimMonth" maxlength="50" class="samll_input_text" style="clear: both;float: none;"/><%--&nbsp;&nbsp;个月--%>
            ...
            <fieldset>
                ...
                <dl style="width: 100%;height: 52px">
                    <dd style="width: 90%;line-height: 26px;margin-left: 5px;">
                        ...
                        <input type="text" name="moveMonth" style="margin-left: 0px;width: 100px;clear: both;float: none;"/>个月;
