                    ...
                    okCall: function(){
                        ...
                        if (data.noRegisterLegal != null && data.noRegisterLegal > 0) {
                            ...
                            if (noRegisterProp != undefined) {
                                ...
                                $("#swapHouseDiv input[name='noRegisterProportion']").eq(0).val(noRegisterProp);
                            } else {
                                $("#swapHouseDiv input[name='noRegisterProportion']").eq(0).val("100");
                            }
                        ...
                        if (data.historyLegacy != null && data.historyLegacy > 0) {
                            ...
                            if (historyProp != undefined) {
                                ...
                                $("#swapHouseDiv input[name='historyProportion']").eq(0).val(historyProp);
                            } else {
                                $("#swapHouseDiv input[name='historyProportion']").eq(0).val("100");
                            }
                        }
