...
(function (factory) {
    if (typeof window.define === 'function') {
        ...
        // 引用 css —— webapck
        window.wangEditorCssPath ? require(window.wangEditorCssPath) : require('http://7xoc8b.com1.z0.glb.clouddn.com/wangEditor.css');
    ...
    _e(function (E, $) {
        ...
        Txt.fn.bindEnterForDiv = function () {
            ...
            function divHandler() {
                ...
                var $pElem = $('<p>' + $keydownDivElem.html() + '</p><br />');
...
// upload img 插件
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            // 自定义UI，并添加到上传dom节点上
            var $uploadIcon = $('<div id="selectfiles" class="upload-icon-container"><i class="wangeditor-menu-img-upload"></i></div>');
...
// 自定义上传
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            var $uploadIcon = $('<div class="upload-icon-container"> <div class="form-group" style="overflow:hidden"> <input style="font-size:12px" type="file" id="file-upload" /> </div></div>');
